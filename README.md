...
> 프론트엔드, 백엔드, 배포 등 모든 기술 스택을 담당했으며, UI/UX 디자인을 공동으로 기획했습니다.

> 프로젝트 후반, 코드를 정리하는 목적으로 바이브 코딩 방식을 적극적으로 활용하였습니다.

💼 **FE Engineer at [CashMap Corp.](https://cashmap.kr) | 2023.08 ~ 2024.12**
> React와 Socket.io를 활용한 실시간 채팅 기능을 개발하고 서비스를 운영했습니다.

> 모바일(AOS/iOS) 및 웹 플랫폼의 시스템을 관리하고 기능을 고도화했습니다.

<br />

## **Blog** 📝

[![Velog](https://img.shields.io/badge/Velog-20C997?style=flat-square&logo=Vimeo&logoColor=white)](https://velog.io/@creatyjohn/posts) **CreatyJohn의 개발 블로그**
...
![Cloudflare](https://img.shields.io/badge/cloudflare-%23FF9900.svg?style=for-the-badge&logo=cloudflare&logoColor=white)
...
> Handled all technical aspects from front-end to back-end and deployment, while co-planning the overall UI/UX design.

> Towards the end of the project, I dedicated time to cleaning up the codebase, applying a consistent coding paradigm for better readability and maintenance.

💼 **FE Engineer at [CashMap Corp.](http://cashmap.kr) | 2023.08 ~ 2024.12**
> Developed and maintained a real-time chatting service using React and Socket.IO.

> Managed and enhanced functionalities for both mobile (AOS/iOS) and web platforms.

<br />

## **Blog** 📝

[![Velog](https://img.shields.io/badge/Velog-20C997?style=flat-square&logo=Vimeo&logoColor=white)](https://velog.io/@creatyjohn/posts) **My Tech Blog**
